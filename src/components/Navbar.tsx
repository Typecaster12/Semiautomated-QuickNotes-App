import { Layout, Zap, Menu, X, LogOut, User as UserIcon } from "lucide-react";
                    ...
                    <div className="hidden md:flex items-center space-x-4">
                        {user ? (
                            <>
                                ...
                                <div className="ml-4 flex items-center gap-4 border-l border-zinc-200 pl-4">
            ...
            {isOpen && (
                <div className="md:hidden">
                    <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t border-zinc-200">
                        {user ? (
                            <>
                                <div className="px-3 py-2 text-base font-medium text-zinc-500 flex items-center gap-2 border-b border-zinc-100 mb-2 pb-2">
                                    <UserIcon className="w-4 h-4" />
                                ...
                                <button
                                    ...
                                    className="w-full text-left px-3 py-2 rounded-md text-base font-medium text-red-600 hover:bg-red-50 flex items-center gap-2 mt-2"
                                >
                            ...
                            <Link
                                to="/login"
                                onClick={() => setIsOpen(false)}
                                className="block w-full text-center px-3 py-2 rounded-md text-base font-medium bg-zinc-900 text-white hover:bg-zinc-800"
                            >
                                Sign In
                            </Link>
                        )}
